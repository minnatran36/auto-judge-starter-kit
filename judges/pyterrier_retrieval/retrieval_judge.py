...
class RetrievalJudge(AutoJudge):
    ...
    def judge(self, rag_responses: Sequence["Report"], rag_topics: Sequence["Request"], llm_cfg: LlmConfigProtocol, nugget_banks: Optional[NuggetBanksProtocol] = None, **kwargs) -> "Leaderboard":
